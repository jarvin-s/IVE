    ...
    return (
        <div className='container mx-auto px-4 py-8'>
            ...
            {user && stats?.userStats && (
                <div className='mb-8 rounded-lg border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 p-6 dark:border-blue-800 dark:from-blue-950 dark:to-indigo-950'>
                        ...
                        <tbody className='bg-popover divide-muted divide-y'>
                            {leaderboardData.map((entry) => {
                                ...
                                return (
                                    <tr
                                        key={entry.rank}
                                        className={`hover:bg-muted/50 transition-colors duration-200 ${entry.rank === 1 ? 'bg-yellow-50/20 dark:bg-yellow-950/20' : ''} ${isCurrentUser ? 'border-l-4 border-blue-500 bg-blue-50/20 dark:bg-blue-950/20' : ''} `}
                                    >
